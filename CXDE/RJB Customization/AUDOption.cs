...
namespace CXDE.RJB_Customization
{
    public class AUDOption
    {
        ...
        public void EndCallAUDRecord()
        {
            ...
            string dialedNumber = ((CallVariable)_Dialog._MediaProperties._CallVariables[6])._Value;
            ...
            {
                string url = _CTIWebServer + "AUDEndCall?agentId=" + _FinAgent._agentInformation.AgentID;
        ...
        public void StartCallAUDRecord()
        {
            ...
            string exitPoint = ((CallVariable)_Dialog._MediaProperties._CallVariables[2])._Value;
            string cic = ((CallVariable)_Dialog._MediaProperties._CallVariables[3])._Value;
            string dialedNumber = ((CallVariable)_Dialog._MediaProperties._CallVariables[6])._Value;
            string appName = ((CallVariable)_Dialog._MediaProperties._CallVariables[0])._Value;
            string audOptions = "";
            ...
            {
                string url = _CTIWebServer + "AUDNewCall?cic=" + TrimLeftZeros(cic) + "&agentId=" + _FinAgent._agentInformation.AgentID + "&options=" + audOptions;
                SendHTTPRequest(url, "GET");
            }
            if (dialedNumber.Equals("KWTRETAIL") || dialedNumber.Equals("CREDIT_ADV"))
            {
                string url = _CTIWebServer + "AUDNewCall?cic=" + "" + "&agentId=" + _FinAgent._agentInformation.AgentID + "&options=" + audOptions;
                SendHTTPRequest(url, "GET");
            }
